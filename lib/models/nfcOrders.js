// ─────────────────────────────────────────────────────────────────────────────
// NFC ORDERS MODEL — Physical NFC card orders linked to a business profile
//
// Collection: `nfc_orders`
// Fields: userId, profileId, cardType (pvc/metal/wood), quantity, design,
//   contactInfo, shippingAddress, status, totalPrice, paymentStatus
// Status pipeline: pending → confirmed → processing → shipped → delivered (or cancelled)
// Pricing logic lives in lib/nfc-pricing.js (re-exported here for convenience).
// ─────────────────────────────────────────────────────────────────────────────
