...
//
// Collection: `password_reset_tokens`  (TTL: auto-expires via expiresAt index)
// Stores hashed reset tokens issued by /api/auth/forgot-password.
// Verified by /api/auth/reset-password to allow setting a new password.
// ─────────────────────────────────────────────────────────────────────────────
