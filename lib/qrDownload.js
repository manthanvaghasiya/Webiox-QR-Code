// ─────────────────────────────────────────────────────────────────────────────
// QR DOWNLOAD / RENDERER — Client-side QR generation
//
// Wraps the `qr-code-styling` library to build a styled QRCodeStyling instance
// from a saved QR record (its design field, destination, dynamic shortId, etc).
// Exports:
//   buildQrCodeStyling(qr, size)  — returns a renderable instance
//   downloadQrCode(qr, format)    — triggers PNG/SVG/PDF/JPG download
// Used by the dashboard QR cards, generator preview, and ProfileCard.
// ─────────────────────────────────────────────────────────────────────────────
