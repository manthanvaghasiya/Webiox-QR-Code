...
export const metadata = {
  title: "Sign Up — Coming Soon · Webiox QR Studio",
  description: "Create a Webiox QR Studio account. Coming soon.",
};
    ...
    <div className="animate-gradient-mesh flex-grow flex flex-col items-center justify-center px-4 py-20 w-full">
      <div className="max-w-md w-full rounded-3xl border border-white/30 bg-white/70 backdrop-blur-xl shadow-2xl p-10 text-center">
        ...
        <p className="text-sm text-gray-500 leading-relaxed mb-8">
          Right now everything works without an account — just go to the generator.
        </p>
        <Link
          href="/generator"
          className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white font-bold text-sm shadow-md hover:opacity-95 transition-opacity"
        >
          Go to the Generator
        </Link>
        <div className="mt-4">
